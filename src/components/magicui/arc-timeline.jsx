...
export function ArcTimeline(props) {
  ...
  return (
    ...
    <motion.div
        ...
        initial={{ rotate: circleContainerRotateDeg - 30, opacity: 0, scale: 0.9 }}
        animate={{ rotate: circleContainerRotateDeg, opacity: 1, scale: 1 }}
                ...
                return (
                  <div key={`${lineIndex}-${stepIndex}`}>
                    ...
                    <div
                      ...
                      <div
                        className={cn("h-full w-full transition-colors duration-200", isActive
                        ...
                        <div
                          className={cn("absolute bottom-0 left-1/2 aspect-square -translate-x-1/2", isActive
