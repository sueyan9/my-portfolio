...
export const portfolioAssistantKnowledge = [
  {
    ...
    cards: [
      { title: "LinkedIn", label: "View profile", href: "https://www.linkedin.com/in/sue-yan-b74a72274/" },
      { title: "GitHub", label: "See repositories", href: "https://github.com/sueyan9" },
    ],
  },
  {
    id: "projects",
  ...
  },
  {
    ...
    cards: [
      { title: "Projects", label: "Review portfolio work", href: "#projects" },
      { title: "Tech Stack", label: "See core stack", href: "#tech-stack" },
    ],
  },
  {
    ...
    cards: [
      { title: "LinkedIn", label: "Message Sue", href: "https://www.linkedin.com/in/sue-yan-b74a72274/" },
      { title: "GitHub", label: "Open profile", href: "https://github.com/sueyan9" },
    ],
  },
  {
    ...
    cards: [
      { title: "Clinic System", label: "See project section", href: "#projects" },
      { title: "3D Dental Chart", label: "Open live demo", href: "https://tooth-mate-app-2025.vercel.app/" },
    ],
  },
  {
    ...
    cards: [
      { title: "SPEED", label: "Open GitHub", href: "https://github.com/sueyan9/SPEED" },
      { title: "Internship Platform", label: "Visit company site", href: "https://www.matricle.com/" },
    ],
  },
  {
    id: "production-stack",
    ...
    cards: [
      { title: "Clinic System", label: "Review project", href: "#projects" },
      { title: "SPEED", label: "Open repository", href: "https://github.com/sueyan9/SPEED" },
      { title: "Matricle", label: "Internship company", href: "https://www.matricle.com/" },
    ],
  },
  {
    id: "full-stack",
    ...
    cards: [
      { title: "ToothMate", label: "See project section", href: "#projects" },
      { title: "SPEED", label: "Open GitHub", href: "https://github.com/sueyan9/SPEED" },
    ],
  },
  {
    ...
    cards: [
      { title: "Portfolio Assistant", label: "See live assistant", href: "#top" },
  ...
  },
  {
    ...
    cards: [
      { title: "GitHub", label: "Review code", href: "https://github.com/sueyan9" },
      { title: "LinkedIn", label: "Connect with Sue", href: "https://www.linkedin.com/in/sue-yan-b74a72274/" },
    ],
  },
  {
    id: "contact",
    ...
    cards: [
      { title: "LinkedIn", label: "Open LinkedIn", href: "https://www.linkedin.com/in/sue-yan-b74a72274/" },
      { title: "GitHub", label: "Open GitHub", href: "https://github.com/sueyan9" },
      { title: "Portfolio", label: "Browse projects", href: "#projects" },
    ],
  },
];
...
export const portfolioAssistantFallback = {
  ...
  cards: [
    { title: "Projects", label: "Ask about projects", href: "#projects" },
    { title: "Skills", label: "Ask about backend experience", href: "#tech-stack" },
  ],
};
